        ...
        {navigationData.map((item, index) => (
          <a
            ...
            className={classNames([
              "w-22 text-gray-500 text-xl hover:text-red-400 hover:border-red-400 hover:border-b-4 font-semibold cursor-pointer font-large tracking-wide text-sm flex items-start justify-center py-2 px-4",
              currentRoute === item &&
