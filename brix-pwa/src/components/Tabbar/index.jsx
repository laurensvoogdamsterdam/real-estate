...
const Tabbar = ({ user, nav, currentRoute, setCurrentRoute }) => {
  ...
  return (
    <nav className='flex md:hidden flex-row items-center justify-around px-8 z-20 h-18 py-3 bg-white visible md:invisible fixed  bottom-0 w-full rounded-t-3xl text-2xl'>
      {user
