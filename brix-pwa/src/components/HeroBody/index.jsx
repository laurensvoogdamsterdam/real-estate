...
const features = [
  {id:"0", name: '10-year all-inclusive warranty', description: 'We’ll replace it with a new one', icon: <AddBoxIcon className="text-white"/> },
  {id:"1", name: 'Free shipping on returns', description: 'Send it back for free', icon: <AcUnitIcon className="text-white"/> },
  {id:"2", name: 'Free, contactless delivery', description: 'The shipping is on us', icon: <AccessAlarmsIcon className="text-white"/> },
]
