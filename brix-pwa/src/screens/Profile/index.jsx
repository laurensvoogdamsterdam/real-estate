...
export default function Profile() {
  return (
    <div className='mx-auto bg-gray-50'>
      <div className='bg-gray-50 max-w-5xl mx-auto'>
        <div className='mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8'>
          <div className='lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16'>
            <div className='lg:row-end-1 lg:col-span-4'>
              <div className='aspect-w-3 aspect-h-3 rounded-full bg-gray-100 overflow-hidden'>
            ...
            <div className='max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-3'>
              ...
              <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2'>
                <button
                  type='button'
                  className='w-full bg-red-800 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500'>
                  Pay {product.price}
                </button>
                <button
                  type='button'
              ...
              <div className='border-t border-gray-200 mt-10 pt-10'>
                ...
                <ul className='flex items-center space-x-6 mt-4'>
                  <li>
                    <button className='flex items-center justify-center w-6 h-6 text-gray-400 hover:text-gray-500'>
